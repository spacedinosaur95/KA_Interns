...
* Technical Goals 
    ...
    + Document Design 
    + Incorporate Human Factors in the development of the user interface for the web application  
...
This project will be managed in 6 major phases. 
